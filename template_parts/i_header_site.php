<header id="header-site" class="bg-negro">
    <div class="container-fluid wrap">
        <div class="row justify-content-between align-items-center">
            <div id="identidad-site" class="col-md-6 d-flex align-items-center">
                <div class="logo-header">
                    <h1><a href="index.php"><img src="images/logo.svg" alt="EcoPark Center" title="EcoPark Center"></a></h1>
                </div>
